      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-16 items-start">
            <div className="md:col-span-2 prose prose-lg max-w-none pl-0">
              ...
              <div className="bg-slate-50 border-l-4 border-slate-500 p-6 rounded-r-lg mb-6">
                <h3 className="text-xl font-semibold mb-3 text-slate-900">The 2024 Big Idea Challenge Team: METALS</h3>
        ...
        >
          ...
          <div className="prose prose-lg max-w-none pl-0">
            ...
            <div className="bg-slate-50 border-l-4 border-slate-500 p-6 rounded-r-lg">
              <h3 className="text-xl font-semibold mb-3 text-slate-900">Technology Demonstration Goal</h3>
              <p className="text-slate-700">
              ...
              <ol className="list-decimal list-inside mt-3 space-y-1 text-slate-700">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none pl-0">
            ...
            <div className="bg-slate-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-semibold mb-3 text-slate-900">Sinusoidal Wave Function Implementation</h3>
            ...
            <div className="bg-slate-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-semibold mb-3 text-slate-900">Advanced Shape: Truncated OTR (TOTR)</h3>
              <p className="text-slate-700 mb-4">
          ...
          <div className="prose prose-lg max-w-none pl-0">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              <div className="bg-slate-50 p-4 rounded-lg">
                <h4 className="font-semibold text-slate-900 mb-2">Shapes Produced</h4>
              ...
              <div className="bg-slate-50 p-4 rounded-lg">
                <h4 className="font-semibold text-slate-900 mb-2">Materials Used</h4>
                <ul className="text-sm text-slate-700 space-y-1">
                  <li>• Al 6061</li>
              ...
              <div className="bg-slate-50 p-4 rounded-lg">
                <h4 className="font-semibold text-slate-900 mb-2">Thickness Range</h4>
            ...
            <div className="bg-slate-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-slate-900">Inflation Testing</h3>
              <p className="text-slate-700 mb-4">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none pl-0">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-slate-900">Vacuum Chamber Testing</h3>
                <p className="text-slate-700">
              ...
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-slate-900">Micrometeorite Impact Testing</h3>
                <p className="text-slate-700">
              ...
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-slate-900">Abrasion Resistance Testing</h3>
                <p className="text-slate-700">
              ...
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-slate-900">Strength & Pressure Testing</h3>
                <p className="text-slate-700">
